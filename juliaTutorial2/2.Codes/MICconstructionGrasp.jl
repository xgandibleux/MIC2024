...
# =============================================================================
# Constructive greedy randomized algorithm building a feasible solution (naive implementation)
# Implementation style to highlight the different steps of the algorithm (could be optimized)

function greedyRandomizedConstruction(C_in, A_in, α)

    println("  Construction (grasp)...")
    start = time()
